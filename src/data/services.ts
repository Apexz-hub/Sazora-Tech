...
export const services: Service[] = [
  {
    ...
    packages: [
      { name: "Landing Page", price: "Rp 150.000", description: "1 halaman, hero section, CTA, kontak" },
      { name: "Portofolio", price: "Rp 250.000", description: "3-5 halaman, galeri project, about, kontak" },
      { name: "Bisnis", price: "Rp 400.000", description: "5-8 halaman, CMS ready, blog, fitur lengkap" },
    ],
  ...
  },
  {
    ...
    packages: [
      { name: "Basic", price: "Rp 100.000", description: "5 channel, 3 role, verifikasi dasar" },
      { name: "Standard", price: "Rp 200.000", description: "15 channel, 8 role, auto mod, welcome bot" },
      { name: "Premium", price: "Rp 350.000", description: "Unlimited channel, full role system, custom bot, integrasi" },
    ],
  ...
  },
  {
    ...
    packages: [
      { name: "Simple", price: "Rp 200.000", description: "5 command dasar, response text, utility" },
      { name: "Advanced", price: "Rp 450.000", description: "15+ command, database, economy/mod system" },
      { name: "Enterprise", price: "Rp 800.000", description: "Custom fitur unlimited, dashboard web, API integration" },
    ],
  ...
  },
  {
    ...
    packages: [
      { name: "Starter", price: "Rp 150.000", description: "Auto reply, menu text, broadcast 50/hari" },
      { name: "Business", price: "Rp 350.000", description: "Google Sheets integration, custom menu, broadcast 500/hari" },
      { name: "Pro", price: "Rp 600.000", description: "Full API integration, database, unlimited broadcast, custom fitur" },
    ],
